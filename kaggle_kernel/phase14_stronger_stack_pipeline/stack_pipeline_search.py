...
#      --output-dir /kaggle/working/phase14_stronger_stack_pipeline_v1
#
# 2) Local smoke:
#    python stack_pipeline_search.py \
#      --config-path stack_pipeline_config_smoke.json \
#      --output-dir .artifacts/smoke_phase14_stack_pipeline/output
...
DEFAULT_REMOTE_CONFIG: dict[str, Any] = {
    "run_name": "phase14_stronger_stack_pipeline_v2",
    "seed": 42,
    "id_col": "id",
    "target_col": "Churn",
    "n_meta_folds": 5,
    ...
    "anchor_model_name": "phase13_hybrid_best_v1",
    "reference_model_name": "phase13_hybrid_best_v1",
    "models": [
        {
            "name": "phase13_hybrid_best_v1",
            "oof_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase13_oof_phase13_best.csv",
            "submission_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase13_submission_phase13_best.csv",
        },
        {
            "name": "phase10_stack_best_v1",
            "oof_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase10_oof_stack_best.csv",
            "submission_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase10_submission_stack_best.csv",
        },
        {
            "name": "phase7_blend_best_v1",
            "oof_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase7_oof_blend_opt.csv",
            "submission_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase7_submission_blend_opt.csv",
        },
        {
            "name": "phase8_cat_v1",
            "oof_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase8_oof_cat.csv",
            "submission_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase8_submission_cat.csv",
        },
        {
            "name": "phase9_realmlp_v2",
            "oof_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase9_oof_realmlp.csv",
            "submission_path": "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs/phase9_submission_realmlp.csv",
        },
    ],
    "candidate_sets": [
        {
            "name": "stack_plus_diversity",
            "models": [
...
REMOTE_INPUT_PREFIX = "/kaggle/input/ps-s6e3-phase14-stack-pipeline-inputs"
REMOTE_REQUIRED_FILES = (
    ...
    "phase7_oof_blend_opt.csv",
    "phase7_submission_blend_opt.csv",
    "phase8_oof_cat.csv",

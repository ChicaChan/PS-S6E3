...
#      --output-dir /kaggle/working/phase11_hybrid_v1
#
# 2) Local smoke:
#    python hybrid_search.py \
#      --config-path hybrid_config_smoke.json \
#      --output-dir .artifacts/smoke_phase11_hybrid/output
...
def main() -> None:
    ...
    if output_dir is None:
        if remote_input_root is not None:
            output_dir = Path("/kaggle/working/phase11_hybrid_v1")
        else:

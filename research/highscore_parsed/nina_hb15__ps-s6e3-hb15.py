...
# %% cell 4
params = {
  'path'     : f'/kaggle/input/datasets/nina2025/ps-s6e3-10/0.91',
  'id_target': ['id', "Churn"],
  'type_sort': ['asc/desc',0.30,0.70 ],
  'subwts'   : [ -0.07,-0.04, 0.00, +0.11 ],
  'subm'     : [ 
      {'name': f'658', 'weight':0.25, 'color':'navy'},
      {'name': f'672', 'weight':0.25, 'color':'darkorange'},
      {'name': f'682', 'weight':0.25, 'color':'darkgreen'},
      {'name': f'684', 'weight':0.25, 'color':'crimson'},]
}
df = h_blend(params, details=True, subm='A.csv')
...
params = {
  ...
  'subwts'   : [ -0.07,-0.04, 0.00, +0.11 ],
  'subm'     : [ 
      {'name': f'650', 'weight':0.22, 'color':'navy'},
      {'name': f'662', 'weight':0.23, 'color':'darkorange'},
      {'name': f'682', 'weight':0.27, 'color':'darkgreen'},
      {'name': f'684', 'weight':0.28, 'color':'crimson'},]
}
df = h_blend(params, details=True, subm='B.csv')
...
params = {
  ...
  'id_target': ['id', "Churn"],
  'type_sort': ['asc/desc',0.30,0.70 ],
  'subwts'   : [ -0.07, 0.00, +0.11, -0.04 ],
  'subm'     : [ 
      {'name': f'650', 'weight':0.22, 'color':'navy'},
      {'name': f'658', 'weight':0.27, 'color':'darkorange'},
      {'name': f'662', 'weight':0.23, 'color':'darkgreen'},
      {'name': f'672', 'weight':0.28, 'color':'crimson'},]
}
df = h_blend(params, details=True, subm='C.csv')
...
params = {
  ...
  'subm'     : [ 
      {'name': f'A', 'weight':+1.09, 'color':'navy'},
      {'name': f'B', 'weight':-0.05, 'color':'darkorange'},
      {'name': f'C', 'weight':-0.04, 'color':'darkgreen'}]
}
...
params = {
  ...
  'id_target': ['id', "Churn"],
  'type_sort': ['asc/desc',0.30,0.70 ],
  'subwts'   : [ +0.11,+0.04, 0.00, -0.02,-0.05,-0.08 ],
  'subm'     : [ 
      {'name': f'650', 'weight':-0.04,'color':'navy'},
      {'name': f'658', 'weight':0.27, 'color':'darkorange'},
      {'name': f'662', 'weight':-0.04,'color':'darkgreen'},
      {'name': f'672', 'weight':0.27, 'color':'crimson'},
      {'name': f'682', 'weight':0.27, 'color':'darkmagenta'},
      {'name': f'684', 'weight':0.27, 'color':'maroon'},]
}
df = h_blend(params, details=True, subm='D.csv')
...
params = {
  ...
  'id_target': ['id', "Churn"],
  'type_sort': ['asc/desc',0.30,0.70 ],
  'subwts'   : [ -0.01, +0.10, -0.05, -0.04 ],
  'subm'     : [ 
      {'name': f'A', 'weight':+1.10, 'color':'navy'},
      {'name': f'B', 'weight':-0.05, 'color':'darkorange'},
      {'name': f'C', 'weight':-0.04, 'color':'darkgreen'},
      {'name': f'D', 'weight':-0.01, 'color':'crimson'},]
}
df = h_blend(params, details=True, subm='cross.csv')
